    ...
    var parse = function (parser, esModule) {
      var handleWorker = function (workerTypeString) { return function (expr) {
        ...
        if (isStrictModule) {
          ...
          var dep$1 = new ModuleDecoratorDependency(ParserHelpers.getModulePath(parser.state.module.context, loaderRequest), parser.state.module);
          dep$1.loc = expr.loc;
          parser.state.module.addDependency(dep$1);
        } else {
          // For CommonJS/Auto
